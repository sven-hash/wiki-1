...
1. Download the executable file in line with your set-up (macOS, Windows, Linux) from the [latest release](https://github.com/alephium/alephium-frontend/releases) and double click on it to install the application.
